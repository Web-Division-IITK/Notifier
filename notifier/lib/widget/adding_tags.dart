...
//   List<dynamic> tags;
//   final Function addingvalue;
//   AddingTags(this.tag, this.tags, this.tagController,this.addingvalue);
//   @override
...
//               ),
//               child: Text('Add Tags', style: TextStyle(color: Colors.white)),
//               onPressed: () {
//                 showDialog(
//                     context: context,
...
//                                 Container(
//                                   padding:
//                                       EdgeInsets.only(bottom: 5.0, top: 25.0),
//                                   // height: 100.0,
//                                   child: Row(
//                                       mainAxisAlignment: MainAxisAlignment.end,
//                                       children: <Widget>[
...
//         ),
//       ],
//       message: CreateChips(this.widget.tag, this.widget.tags,addingvalue:widget.addingvalue),
//       cancelButton: Column(
//         children: <Widget>[
//           RaisedButton(
//             shape: RoundedRectangleBorder(
...
//             onPressed: () {
//               setState(() {
//                 widget.addingvalue(widget.tags,widget.tag);
