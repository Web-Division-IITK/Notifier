...
//   /// list of posts which contains all posts for one post just pass the Posts parameter inside []
...
//                                     time: tz.TZDateTime.now(tz.local)).initiate;
...
//     );
//   }
//   Future<bool> createEvent(String id,Posts posts)async{
//     posts.id = id;
...
//       return await DatabaseProvider().insertPost(postsFromJson(json.encode(post))).then((value)async{
//         print("SUCCESSFULLY CREATED EVENT !!!");
//         await EventReminderNotification(
//           'Event has started',reminder: posts,id: posts.timeStamp,
//           time: DateTime.fromMillisecondsSinceEpoch(posts.startTime)).initiate;
//         return true;
//       });
//     }catch(e){
