        ...
        child: GestureDetector(
          ...
          child: Opacity(
            ...
            child: Container(
              ...
              height: realH(122 + (700 - 122) * currentExplorePercent),
              ...
              child: Stack(
                children: [
                  Positioned(
                      ...
                      // bottom: realH(80 + (-5 * currentExplorePercent)),
                      child: Text(
                        "Explore",
                        style: TextStyle(color: Colors.white, fontSize: realW(18 + (27 - 18) * currentExplorePercent)),
                        // style: TextStyle(color: Colors.white, fontSize: realW(18 + (32 - 18) * currentExplorePercent)),
                      )),
                  Positioned(
                      top: realH(25 + (60 - 20) * currentExplorePercent),
